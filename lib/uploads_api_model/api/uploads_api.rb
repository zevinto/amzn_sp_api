...
module AmznSpApi::UploadsApiModel
  class UploadsApi
    ...
    def create_upload_destination_for_resource_with_http_info(marketplace_ids, content_md5, resource, opts = {})
      @api_client.config.logger.debug 'Calling API: UploadsApi.create_upload_destination_for_resource ...' if @api_client.config.debugging
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling UploadsApi.create_upload_destination_for_resource" if @api_client.config.client_side_validation && marketplace_ids.nil?
      # verify the required parameter 'content_md5' is set
      raise ArgumentError, "Missing the required parameter 'content_md5' when calling UploadsApi.create_upload_destination_for_resource" if @api_client.config.client_side_validation && content_md5.nil?
      # verify the required parameter 'resource' is set
      raise ArgumentError, "Missing the required parameter 'resource' when calling UploadsApi.create_upload_destination_for_resource" if @api_client.config.client_side_validation && resource.nil?
      ...
      query_params[:contentType] = opts[:content_type] unless opts[:content_type].nil?
