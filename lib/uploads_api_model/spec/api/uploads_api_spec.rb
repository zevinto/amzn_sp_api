...
# Unit tests for AmznSpApi::UploadsApiModel::UploadsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadsApi' do
  before do
    # run before each test
    @instance = AmznSpApi::UploadsApiModel::UploadsApi.new
  end
  ...
  describe 'test an instance of UploadsApi' do
    it 'should create an instance of UploadsApi' do
      expect(@instance).to be_instance_of(AmznSpApi::UploadsApiModel::UploadsApi)
    end
  end
