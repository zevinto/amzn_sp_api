...
# Unit tests for AmznSpApi::NotificationsApiModel::Subscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Subscription' do
  before do
    # run before each test
    @instance = AmznSpApi::NotificationsApiModel::Subscription.new
  end
  ...
  describe 'test an instance of Subscription' do
    it 'should create an instance of Subscription' do
      expect(@instance).to be_instance_of(AmznSpApi::NotificationsApiModel::Subscription)
    end
  end
