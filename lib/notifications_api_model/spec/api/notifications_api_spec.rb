...
# Unit tests for AmznSpApi::NotificationsApiModel::NotificationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationsApi' do
  before do
    # run before each test
    @instance = AmznSpApi::NotificationsApiModel::NotificationsApi.new
  end
  ...
  describe 'test an instance of NotificationsApi' do
    it 'should create an instance of NotificationsApi' do
      expect(@instance).to be_instance_of(AmznSpApi::NotificationsApiModel::NotificationsApi)
    end
  end
