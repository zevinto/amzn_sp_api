...
# Unit tests for AmznSpApi::ProductPricingApiModel::Points
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Points' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Points.new
  end
  ...
  describe 'test an instance of Points' do
    it 'should create an instance of Points' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Points)
    end
  end
