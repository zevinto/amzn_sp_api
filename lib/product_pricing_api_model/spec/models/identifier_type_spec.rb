...
# Unit tests for AmznSpApi::ProductPricingApiModel::IdentifierType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdentifierType' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::IdentifierType.new
  end
  ...
  describe 'test an instance of IdentifierType' do
    it 'should create an instance of IdentifierType' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::IdentifierType)
    end
  end
