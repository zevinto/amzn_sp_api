...
# Unit tests for AmznSpApi::ProductPricingApiModel::FulfillmentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentType' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::FulfillmentType.new
  end
  ...
  describe 'test an instance of FulfillmentType' do
    it 'should create an instance of FulfillmentType' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::FulfillmentType)
    end
  end
end
