...
# Unit tests for AmznSpApi::ProductPricingApiModel::BatchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::BatchResponse.new
  end
  ...
  describe 'test an instance of BatchResponse' do
    it 'should create an instance of BatchResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::BatchResponse)
    end
  end
