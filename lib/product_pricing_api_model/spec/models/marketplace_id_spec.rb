...
# Unit tests for AmznSpApi::ProductPricingApiModel::MarketplaceId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceId' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::MarketplaceId.new
  end
  ...
  describe 'test an instance of MarketplaceId' do
    it 'should create an instance of MarketplaceId' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::MarketplaceId)
    end
  end
end
