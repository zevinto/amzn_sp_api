...
# Unit tests for AmznSpApi::ProductPricingApiModel::FeaturedOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeaturedOffer' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::FeaturedOffer.new
  end
  ...
  describe 'test an instance of FeaturedOffer' do
    it 'should create an instance of FeaturedOffer' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::FeaturedOffer)
    end
  end
