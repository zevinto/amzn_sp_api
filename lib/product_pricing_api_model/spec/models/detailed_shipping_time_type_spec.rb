...
# Unit tests for AmznSpApi::ProductPricingApiModel::DetailedShippingTimeType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DetailedShippingTimeType' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::DetailedShippingTimeType.new
  end
  ...
  describe 'test an instance of DetailedShippingTimeType' do
    it 'should create an instance of DetailedShippingTimeType' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::DetailedShippingTimeType)
    end
  end
