...
# Unit tests for AmznSpApi::ProductPricingApiModel::HttpStatusLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpStatusLine' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::HttpStatusLine.new
  end
  ...
  describe 'test an instance of HttpStatusLine' do
    it 'should create an instance of HttpStatusLine' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::HttpStatusLine)
    end
  end
