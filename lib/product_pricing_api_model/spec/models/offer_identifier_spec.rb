...
# Unit tests for AmznSpApi::ProductPricingApiModel::OfferIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfferIdentifier' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::OfferIdentifier.new
  end
  ...
  describe 'test an instance of OfferIdentifier' do
    it 'should create an instance of OfferIdentifier' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::OfferIdentifier)
    end
  end
