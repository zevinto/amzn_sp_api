...
# Unit tests for AmznSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceResponseList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeaturedOfferExpectedPriceResponseList' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceResponseList.new
  end
  ...
  describe 'test an instance of FeaturedOfferExpectedPriceResponseList' do
    it 'should create an instance of FeaturedOfferExpectedPriceResponseList' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceResponseList)
    end
  end
end
