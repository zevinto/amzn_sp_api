...
# Unit tests for AmznSpApi::ProductPricingApiModel::Errors
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Errors' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Errors.new
  end
  ...
  describe 'test an instance of Errors' do
    it 'should create an instance of Errors' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Errors)
    end
  end
