...
# Unit tests for AmznSpApi::ProductPricingApiModel::HttpHeaders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpHeaders' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::HttpHeaders.new
  end
  ...
  describe 'test an instance of HttpHeaders' do
    it 'should create an instance of HttpHeaders' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::HttpHeaders)
    end
  end
end
