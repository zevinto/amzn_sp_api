...
# Unit tests for AmznSpApi::ProductPricingApiModel::MoneyType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MoneyType' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::MoneyType.new
  end
  ...
  describe 'test an instance of MoneyType' do
    it 'should create an instance of MoneyType' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::MoneyType)
    end
  end
