...
# Unit tests for AmznSpApi::ProductPricingApiModel::SellerSKUIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellerSKUIdentifier' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::SellerSKUIdentifier.new
  end
  ...
  describe 'test an instance of SellerSKUIdentifier' do
    it 'should create an instance of SellerSKUIdentifier' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::SellerSKUIdentifier)
    end
  end
