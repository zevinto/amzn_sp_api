...
# Unit tests for AmznSpApi::ProductPricingApiModel::Sku
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Sku' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Sku.new
  end
  ...
  describe 'test an instance of Sku' do
    it 'should create an instance of Sku' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Sku)
    end
  end
end
