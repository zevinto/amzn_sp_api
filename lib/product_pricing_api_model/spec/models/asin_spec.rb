...
# Unit tests for AmznSpApi::ProductPricingApiModel::Asin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Asin' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Asin.new
  end
  ...
  describe 'test an instance of Asin' do
    it 'should create an instance of Asin' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Asin)
    end
  end
end
