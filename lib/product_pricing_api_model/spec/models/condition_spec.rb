...
# Unit tests for AmznSpApi::ProductPricingApiModel::Condition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Condition' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Condition.new
  end
  ...
  describe 'test an instance of Condition' do
    it 'should create an instance of Condition' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Condition)
    end
  end
end
