...
# Unit tests for AmznSpApi::ProductPricingApiModel::BatchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BatchRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::BatchRequest.new
  end
  ...
  describe 'test an instance of BatchRequest' do
    it 'should create an instance of BatchRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::BatchRequest)
    end
  end
