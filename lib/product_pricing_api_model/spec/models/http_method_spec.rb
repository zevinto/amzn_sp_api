...
# Unit tests for AmznSpApi::ProductPricingApiModel::HttpMethod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpMethod' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::HttpMethod.new
  end
  ...
  describe 'test an instance of HttpMethod' do
    it 'should create an instance of HttpMethod' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::HttpMethod)
    end
  end
end
