...
# Unit tests for AmznSpApi::ProductPricingApiModel::Price
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Price' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductPricingApiModel::Price.new
  end
  ...
  describe 'test an instance of Price' do
    it 'should create an instance of Price' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductPricingApiModel::Price)
    end
  end
