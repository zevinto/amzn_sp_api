...
module AmznSpApi::ProductPricingApiModel
  ...
  class FeaturedOfferExpectedPriceRequest
    attr_accessor :marketplace_id, :sku, :method, :body, :headers
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceRequest` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::ProductPricingApiModel::FeaturedOfferExpectedPriceRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "uri", uri cannot be nil.') if @uri.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        method == other.method &&
        body == other.body &&
        headers == other.headers && super(other)
    end
    ...
    def hash
      [marketplace_id, sku, uri, method, body, headers].hash
    end
