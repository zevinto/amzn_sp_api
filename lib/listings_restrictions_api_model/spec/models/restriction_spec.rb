...
# Unit tests for AmznSpApi::ListingsRestrictionsApiModel::Restriction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Restriction' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsRestrictionsApiModel::Restriction.new
  end
  ...
  describe 'test an instance of Restriction' do
    it 'should create an instance of Restriction' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsRestrictionsApiModel::Restriction)
    end
  end
