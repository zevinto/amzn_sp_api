...
# Unit tests for AmznSpApi::ListingsRestrictionsApiModel::Link
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Link' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsRestrictionsApiModel::Link.new
  end
  ...
  describe 'test an instance of Link' do
    it 'should create an instance of Link' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsRestrictionsApiModel::Link)
    end
  end
