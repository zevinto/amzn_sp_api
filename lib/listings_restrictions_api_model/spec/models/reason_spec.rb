...
# Unit tests for AmznSpApi::ListingsRestrictionsApiModel::Reason
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Reason' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsRestrictionsApiModel::Reason.new
  end
  ...
  describe 'test an instance of Reason' do
    it 'should create an instance of Reason' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsRestrictionsApiModel::Reason)
    end
  end
