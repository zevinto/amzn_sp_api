...
module AmznSpApi::ProductTypeDefinitionsApiModel
  class DefinitionsApi
    ...
    def get_definitions_product_type_with_http_info(product_type, marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: DefinitionsApi.get_definitions_product_type ...' if @api_client.config.debugging
      # verify the required parameter 'product_type' is set
      raise ArgumentError, "Missing the required parameter 'product_type' when calling DefinitionsApi.get_definitions_product_type" if @api_client.config.client_side_validation && product_type.nil?
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling DefinitionsApi.get_definitions_product_type" if @api_client.config.client_side_validation && marketplace_ids.nil?
      raise ArgumentError, 'invalid value for "requirements", must be one of LISTING, LISTING_PRODUCT_ONLY, LISTING_OFFER_ONLY' if @api_client.config.client_side_validation && opts[:requirements] && !%w[LISTING LISTING_PRODUCT_ONLY LISTING_OFFER_ONLY].include?(opts[:requirements])
      raise ArgumentError, 'invalid value for "requirements_enforced", must be one of ENFORCED, NOT_ENFORCED' if @api_client.config.client_side_validation && opts[:requirements_enforced] && !%w[ENFORCED NOT_ENFORCED].include?(opts[:requirements_enforced])
      raise ArgumentError, 'invalid value for "locale", must be one of DEFAULT, ar, ar_AE, de, de_DE, en, en_AE, en_AU, en_CA, en_GB, en_IN, en_SG, en_US, es, es_ES, es_MX, es_US, fr, fr_CA, fr_FR, it, it_IT, ja, ja_JP, nl, nl_NL, pl, pl_PL, pt, pt_BR, pt_PT, sv, sv_SE, tr, tr_TR, zh, zh_CN, zh_TW' if @api_client.config.client_side_validation && opts[:locale] && !%w[DEFAULT ar ar_AE de de_DE en en_AE en_AU en_CA en_GB en_IN en_SG en_US es es_ES es_MX es_US fr fr_CA fr_FR it it_IT ja ja_JP nl nl_NL pl pl_PL pt pt_BR pt_PT sv sv_SE tr tr_TR zh zh_CN zh_TW].include?(opts[:locale])
      ...
      query_params[:productTypeVersion] = opts[:product_type_version] unless opts[:product_type_version].nil?
      query_params[:requirements] = opts[:requirements] unless opts[:requirements].nil?
      query_params[:requirementsEnforced] = opts[:requirements_enforced] unless opts[:requirements_enforced].nil?
    ...
    def search_definitions_product_types_with_http_info(marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: DefinitionsApi.search_definitions_product_types ...' if @api_client.config.debugging
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling DefinitionsApi.search_definitions_product_types" if @api_client.config.client_side_validation && marketplace_ids.nil?
