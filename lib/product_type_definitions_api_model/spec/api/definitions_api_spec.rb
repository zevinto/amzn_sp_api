...
# Unit tests for AmznSpApi::ProductTypeDefinitionsApiModel::DefinitionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DefinitionsApi' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductTypeDefinitionsApiModel::DefinitionsApi.new
  end
  ...
  describe 'test an instance of DefinitionsApi' do
    it 'should create an instance of DefinitionsApi' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductTypeDefinitionsApiModel::DefinitionsApi)
    end
  end
