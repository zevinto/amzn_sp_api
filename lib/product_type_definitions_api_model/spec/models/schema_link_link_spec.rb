...
# Unit tests for AmznSpApi::ProductTypeDefinitionsApiModel::SchemaLinkLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchemaLinkLink' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductTypeDefinitionsApiModel::SchemaLinkLink.new
  end
  ...
  describe 'test an instance of SchemaLinkLink' do
    it 'should create an instance of SchemaLinkLink' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductTypeDefinitionsApiModel::SchemaLinkLink)
    end
  end
