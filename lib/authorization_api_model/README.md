...
```shell
gem install ./authorization_api_model-0.1.0.gem
```
(for development, run `gem install --dev ./authorization_api_model-0.1.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'authorization_api_model', '~> 0.1.0'
