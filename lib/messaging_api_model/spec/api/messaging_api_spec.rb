...
# Unit tests for AmznSpApi::MessagingApiModel::MessagingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessagingApi' do
  before do
    # run before each test
    @instance = AmznSpApi::MessagingApiModel::MessagingApi.new
  end
  ...
  describe 'test an instance of MessagingApi' do
    it 'should create an instance of MessagingApi' do
      expect(@instance).to be_instance_of(AmznSpApi::MessagingApiModel::MessagingApi)
    end
  end
