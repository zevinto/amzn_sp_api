...
# Unit tests for AmznSpApi::MessagingApiModel::GetMessagingActionsForOrderResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionsForOrderResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::MessagingApiModel::GetMessagingActionsForOrderResponse.new
  end
  ...
  describe 'test an instance of GetMessagingActionsForOrderResponse' do
    it 'should create an instance of GetMessagingActionsForOrderResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::MessagingApiModel::GetMessagingActionsForOrderResponse)
    end
  end
