...
# Unit tests for AmznSpApi::MessagingApiModel::GetMessagingActionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMessagingActionResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::MessagingApiModel::GetMessagingActionResponse.new
  end
  ...
  describe 'test an instance of GetMessagingActionResponse' do
    it 'should create an instance of GetMessagingActionResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::MessagingApiModel::GetMessagingActionResponse)
    end
  end
