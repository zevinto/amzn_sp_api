...
module AmznSpApi::ServicesApiModel
  ...
  class Poa
    ...
    def poa_type=(poa_type)
      validator = EnumAttributeValidator.new('Object', %w[NO_SIGNATURE_DUMMY_POS CUSTOMER_SIGNATURE DUMMY_RECEIPT POA_RECEIPT])
      raise ArgumentError, "invalid value for \"poa_type\", must be one of #{validator.allowable_values}." unless validator.valid?(poa_type)
