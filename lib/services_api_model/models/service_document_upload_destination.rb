...
module AmznSpApi::ServicesApiModel
  ...
  class ServiceDocumentUploadDestination
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::ServicesApiModel::ServiceDocumentUploadDestination` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::ServicesApiModel::ServiceDocumentUploadDestination`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.encryption_details = attributes[:encryption_details] if attributes.key?(:encryption_details)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "encryption_details", encryption_details cannot be nil.') if @encryption_details.nil?
