...
module AmznSpApi::ServicesApiModel
  ...
  class Error
    ...
    def error_level=(error_level)
      validator = EnumAttributeValidator.new('Object', %w[ERROR WARNING])
      raise ArgumentError, "invalid value for \"error_level\", must be one of #{validator.allowable_values}." unless validator.valid?(error_level)
