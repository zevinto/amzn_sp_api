...
# Unit tests for AmznSpApi::ServicesApiModel::ServiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceApi' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::ServiceApi.new
  end
  ...
  describe 'test an instance of ServiceApi' do
    it 'should create an instance of ServiceApi' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::ServiceApi)
    end
  end
