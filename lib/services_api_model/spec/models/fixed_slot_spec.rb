...
# Unit tests for AmznSpApi::ServicesApiModel::FixedSlot
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedSlot' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::FixedSlot.new
  end
  ...
  describe 'test an instance of FixedSlot' do
    it 'should create an instance of FixedSlot' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::FixedSlot)
    end
  end
