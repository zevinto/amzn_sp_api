...
# Unit tests for AmznSpApi::ServicesApiModel::SetAppointmentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SetAppointmentResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::SetAppointmentResponse.new
  end
  ...
  describe 'test an instance of SetAppointmentResponse' do
    it 'should create an instance of SetAppointmentResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::SetAppointmentResponse)
    end
  end
