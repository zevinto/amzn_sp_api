...
# Unit tests for AmznSpApi::ServicesApiModel::FixedSlotCapacityQuery
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FixedSlotCapacityQuery' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::FixedSlotCapacityQuery.new
  end
  ...
  describe 'test an instance of FixedSlotCapacityQuery' do
    it 'should create an instance of FixedSlotCapacityQuery' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::FixedSlotCapacityQuery)
    end
  end
