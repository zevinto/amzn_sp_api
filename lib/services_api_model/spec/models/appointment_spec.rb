...
# Unit tests for AmznSpApi::ServicesApiModel::Appointment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Appointment' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::Appointment.new
  end
  ...
  describe 'test an instance of Appointment' do
    it 'should create an instance of Appointment' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::Appointment)
    end
  end
