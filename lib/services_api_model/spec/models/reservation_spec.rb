...
# Unit tests for AmznSpApi::ServicesApiModel::Reservation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Reservation' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::Reservation.new
  end
  ...
  describe 'test an instance of Reservation' do
    it 'should create an instance of Reservation' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::Reservation)
    end
  end
