...
# Unit tests for AmznSpApi::ServicesApiModel::FulfillmentDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentDocument' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::FulfillmentDocument.new
  end
  ...
  describe 'test an instance of FulfillmentDocument' do
    it 'should create an instance of FulfillmentDocument' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::FulfillmentDocument)
    end
  end
