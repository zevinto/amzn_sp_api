...
# Unit tests for AmznSpApi::ServicesApiModel::Poa
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Poa' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::Poa.new
  end
  ...
  describe 'test an instance of Poa' do
    it 'should create an instance of Poa' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::Poa)
    end
  end
