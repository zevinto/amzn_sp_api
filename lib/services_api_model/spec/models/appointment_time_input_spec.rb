...
# Unit tests for AmznSpApi::ServicesApiModel::AppointmentTimeInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppointmentTimeInput' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::AppointmentTimeInput.new
  end
  ...
  describe 'test an instance of AppointmentTimeInput' do
    it 'should create an instance of AppointmentTimeInput' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::AppointmentTimeInput)
    end
  end
