...
# Unit tests for AmznSpApi::ServicesApiModel::ServiceLocation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceLocation' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::ServiceLocation.new
  end
  ...
  describe 'test an instance of ServiceLocation' do
    it 'should create an instance of ServiceLocation' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::ServiceLocation)
    end
  end
