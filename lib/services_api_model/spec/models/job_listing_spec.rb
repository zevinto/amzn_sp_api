...
# Unit tests for AmznSpApi::ServicesApiModel::JobListing
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JobListing' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::JobListing.new
  end
  ...
  describe 'test an instance of JobListing' do
    it 'should create an instance of JobListing' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::JobListing)
    end
  end
