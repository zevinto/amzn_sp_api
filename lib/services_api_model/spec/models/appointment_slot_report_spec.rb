...
# Unit tests for AmznSpApi::ServicesApiModel::AppointmentSlotReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AppointmentSlotReport' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::AppointmentSlotReport.new
  end
  ...
  describe 'test an instance of AppointmentSlotReport' do
    it 'should create an instance of AppointmentSlotReport' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::AppointmentSlotReport)
    end
  end
