...
# Unit tests for AmznSpApi::ServicesApiModel::ServiceUploadDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServiceUploadDocument' do
  before do
    # run before each test
    @instance = AmznSpApi::ServicesApiModel::ServiceUploadDocument.new
  end
  ...
  describe 'test an instance of ServiceUploadDocument' do
    it 'should create an instance of ServiceUploadDocument' do
      expect(@instance).to be_instance_of(AmznSpApi::ServicesApiModel::ServiceUploadDocument)
    end
  end
