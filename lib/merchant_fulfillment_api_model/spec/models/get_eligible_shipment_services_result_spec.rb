...
# Unit tests for AmznSpApi::MerchantFulfillmentApiModel::GetEligibleShipmentServicesResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetEligibleShipmentServicesResult' do
  before do
    # run before each test
    @instance = AmznSpApi::MerchantFulfillmentApiModel::GetEligibleShipmentServicesResult.new
  end
  ...
  describe 'test an instance of GetEligibleShipmentServicesResult' do
    it 'should create an instance of GetEligibleShipmentServicesResult' do
      expect(@instance).to be_instance_of(AmznSpApi::MerchantFulfillmentApiModel::GetEligibleShipmentServicesResult)
    end
  end
