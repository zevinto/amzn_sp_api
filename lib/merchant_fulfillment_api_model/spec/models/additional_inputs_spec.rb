...
# Unit tests for AmznSpApi::MerchantFulfillmentApiModel::AdditionalInputs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdditionalInputs' do
  before do
    # run before each test
    @instance = AmznSpApi::MerchantFulfillmentApiModel::AdditionalInputs.new
  end
  ...
  describe 'test an instance of AdditionalInputs' do
    it 'should create an instance of AdditionalInputs' do
      expect(@instance).to be_instance_of(AmznSpApi::MerchantFulfillmentApiModel::AdditionalInputs)
    end
  end
