...
# Unit tests for AmznSpApi::MerchantFulfillmentApiModel::Shipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Shipment' do
  before do
    # run before each test
    @instance = AmznSpApi::MerchantFulfillmentApiModel::Shipment.new
  end
  ...
  describe 'test an instance of Shipment' do
    it 'should create an instance of Shipment' do
      expect(@instance).to be_instance_of(AmznSpApi::MerchantFulfillmentApiModel::Shipment)
    end
  end
