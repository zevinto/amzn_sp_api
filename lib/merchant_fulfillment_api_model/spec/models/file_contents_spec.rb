...
# Unit tests for AmznSpApi::MerchantFulfillmentApiModel::FileContents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileContents' do
  before do
    # run before each test
    @instance = AmznSpApi::MerchantFulfillmentApiModel::FileContents.new
  end
  ...
  describe 'test an instance of FileContents' do
    it 'should create an instance of FileContents' do
      expect(@instance).to be_instance_of(AmznSpApi::MerchantFulfillmentApiModel::FileContents)
    end
  end
