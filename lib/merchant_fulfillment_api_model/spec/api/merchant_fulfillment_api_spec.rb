...
# Unit tests for AmznSpApi::MerchantFulfillmentApiModel::MerchantFulfillmentApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MerchantFulfillmentApi' do
  before do
    # run before each test
    @instance = AmznSpApi::MerchantFulfillmentApiModel::MerchantFulfillmentApi.new
  end
  ...
  describe 'test an instance of MerchantFulfillmentApi' do
    it 'should create an instance of MerchantFulfillmentApi' do
      expect(@instance).to be_instance_of(AmznSpApi::MerchantFulfillmentApiModel::MerchantFulfillmentApi)
    end
  end
