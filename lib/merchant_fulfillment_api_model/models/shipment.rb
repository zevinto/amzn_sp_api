...
module AmznSpApi::MerchantFulfillmentApiModel
  ...
  class Shipment
    attr_accessor :shipment_id, :amazon_order_id, :seller_order_id, :item_list, :ship_from_address, :ship_to_address, :package_dimensions, :weight, :insurance, :shipping_service, :label, :status, :tracking_id, :created_date, :last_updated_date
