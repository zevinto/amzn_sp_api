...
module AmznSpApi::MerchantFulfillmentApiModel
  ...
  class GetEligibleShipmentServicesResult
    attr_accessor :shipping_service_list, :rejected_shipping_service_list, :temporarily_unavailable_carrier_list, :terms_and_conditions_not_accepted_carrier_list
