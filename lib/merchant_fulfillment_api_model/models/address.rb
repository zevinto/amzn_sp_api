...
module AmznSpApi::MerchantFulfillmentApiModel
  ...
  class Address
    attr_accessor :name, :address_line1, :address_line2, :address_line3, :district_or_county, :email, :city, :state_or_province_code, :postal_code, :country_code, :phone
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::MerchantFulfillmentApiModel::Address` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::MerchantFulfillmentApiModel::Address`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "phone", phone cannot be nil.') if @phone.nil?
