...
module AmznSpApi::MerchantFulfillmentApiModel
  ...
  class GetAdditionalSellerInputsRequest
    attr_accessor :shipping_service_id, :ship_from_address, :order_id
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::MerchantFulfillmentApiModel::GetAdditionalSellerInputsRequest` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::MerchantFulfillmentApiModel::GetAdditionalSellerInputsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:order_id)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "order_id", order_id cannot be nil.') if @order_id.nil?
