...
# Unit tests for AmznSpApi::EasyShipModel::Weight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::Weight.new
  end
  ...
  describe 'test an instance of Weight' do
    it 'should create an instance of Weight' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::Weight)
    end
  end
