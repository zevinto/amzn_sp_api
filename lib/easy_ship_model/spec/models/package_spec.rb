...
# Unit tests for AmznSpApi::EasyShipModel::Package
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Package' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::Package.new
  end
  ...
  describe 'test an instance of Package' do
    it 'should create an instance of Package' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::Package)
    end
  end
