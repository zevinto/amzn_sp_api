...
# Unit tests for AmznSpApi::EasyShipModel::ListHandoverSlotsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListHandoverSlotsRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::ListHandoverSlotsRequest.new
  end
  ...
  describe 'test an instance of ListHandoverSlotsRequest' do
    it 'should create an instance of ListHandoverSlotsRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::ListHandoverSlotsRequest)
    end
  end
