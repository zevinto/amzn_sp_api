...
# Unit tests for AmznSpApi::EasyShipModel::DateTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DateTime' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::DateTime.new
  end
  ...
  describe 'test an instance of DateTime' do
    it 'should create an instance of DateTime' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::DateTime)
    end
  end
end
