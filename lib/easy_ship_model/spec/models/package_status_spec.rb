...
# Unit tests for AmznSpApi::EasyShipModel::PackageStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageStatus' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::PackageStatus.new
  end
  ...
  describe 'test an instance of PackageStatus' do
    it 'should create an instance of PackageStatus' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::PackageStatus)
    end
  end
end
