...
# Unit tests for AmznSpApi::EasyShipModel::UnitOfWeight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnitOfWeight' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::UnitOfWeight.new
  end
  ...
  describe 'test an instance of UnitOfWeight' do
    it 'should create an instance of UnitOfWeight' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::UnitOfWeight)
    end
  end
end
