...
# Unit tests for AmznSpApi::EasyShipModel::TrackingDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackingDetails' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::TrackingDetails.new
  end
  ...
  describe 'test an instance of TrackingDetails' do
    it 'should create an instance of TrackingDetails' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::TrackingDetails)
    end
  end
