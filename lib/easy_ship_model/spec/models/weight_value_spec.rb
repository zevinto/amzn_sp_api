...
# Unit tests for AmznSpApi::EasyShipModel::WeightValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WeightValue' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::WeightValue.new
  end
  ...
  describe 'test an instance of WeightValue' do
    it 'should create an instance of WeightValue' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::WeightValue)
    end
  end
end
