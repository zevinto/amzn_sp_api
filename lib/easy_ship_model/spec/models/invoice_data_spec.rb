...
# Unit tests for AmznSpApi::EasyShipModel::InvoiceData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceData' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipModel::InvoiceData.new
  end
  ...
  describe 'test an instance of InvoiceData' do
    it 'should create an instance of InvoiceData' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipModel::InvoiceData)
    end
  end
