...
module AmznSpApi::FulfillmentInboundApiModel
  ...
  class CreateInboundShipmentPlanRequest
    attr_accessor :ship_from_address, :label_prep_preference, :inbound_shipment_plan_request_items
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentInboundApiModel::CreateInboundShipmentPlanRequest` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentInboundApiModel::CreateInboundShipmentPlanRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.label_prep_preference = attributes[:label_prep_preference] if attributes.key?(:label_prep_preference)

      self.ship_to_country_code = attributes[:ship_to_country_code] if attributes.key?(:ship_to_country_code)

      self.ship_to_country_subdivision_code = attributes[:ship_to_country_subdivision_code] if attributes.key?(:ship_to_country_subdivision_code)

      return unless attributes.key?(:inbound_shipment_plan_request_items)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "label_prep_preference", label_prep_preference cannot be nil.') if @label_prep_preference.nil?

      invalid_properties.push('invalid value for "inbound_shipment_plan_request_items", inbound_shipment_plan_request_items cannot be nil.') if @inbound_shipment_plan_request_items.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        label_prep_preference == other.label_prep_preference &&
        ship_to_country_code == other.ship_to_country_code &&
        ship_to_country_subdivision_code == other.ship_to_country_subdivision_code &&
        inbound_shipment_plan_request_items == other.inbound_shipment_plan_request_items
    end
