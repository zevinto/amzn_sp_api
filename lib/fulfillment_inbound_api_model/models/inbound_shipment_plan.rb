...
module AmznSpApi::FulfillmentInboundApiModel
  ...
  class InboundShipmentPlan
    ...
    attr_accessor :ship_to_address, :label_prep_type, :items, :estimated_box_contents_fee
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlan` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlan`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "label_prep_type", label_prep_type cannot be nil.') if @label_prep_type.nil?
