...
module AmznSpApi::FulfillmentInboundApiModel
  ...
  class InboundShipmentPlanItem
    ...
    attr_accessor :quantity, :prep_details_list
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlanItem` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlanItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "fulfillment_network_sku", fulfillment_network_sku cannot be nil.') if @fulfillment_network_sku.nil?
