...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::TransportDetailOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportDetailOutput' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::TransportDetailOutput.new
  end
  ...
  describe 'test an instance of TransportDetailOutput' do
    it 'should create an instance of TransportDetailOutput' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::TransportDetailOutput)
    end
  end
