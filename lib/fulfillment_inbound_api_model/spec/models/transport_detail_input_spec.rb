...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::TransportDetailInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportDetailInput' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::TransportDetailInput.new
  end
  ...
  describe 'test an instance of TransportDetailInput' do
    it 'should create an instance of TransportDetailInput' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::TransportDetailInput)
    end
  end
