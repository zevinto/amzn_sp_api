...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::InboundShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundShipmentRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::InboundShipmentRequest.new
  end
  ...
  describe 'test an instance of InboundShipmentRequest' do
    it 'should create an instance of InboundShipmentRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::InboundShipmentRequest)
    end
  end
