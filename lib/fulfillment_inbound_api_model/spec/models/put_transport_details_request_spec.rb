...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::PutTransportDetailsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PutTransportDetailsRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::PutTransportDetailsRequest.new
  end
  ...
  describe 'test an instance of PutTransportDetailsRequest' do
    it 'should create an instance of PutTransportDetailsRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::PutTransportDetailsRequest)
    end
  end
