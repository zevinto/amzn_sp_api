...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::ASINPrepInstructions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ASINPrepInstructions' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::ASINPrepInstructions.new
  end
  ...
  describe 'test an instance of ASINPrepInstructions' do
    it 'should create an instance of ASINPrepInstructions' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::ASINPrepInstructions)
    end
  end
