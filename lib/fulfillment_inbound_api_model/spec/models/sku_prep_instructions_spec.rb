...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::SKUPrepInstructions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SKUPrepInstructions' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::SKUPrepInstructions.new
  end
  ...
  describe 'test an instance of SKUPrepInstructions' do
    it 'should create an instance of SKUPrepInstructions' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::SKUPrepInstructions)
    end
  end
