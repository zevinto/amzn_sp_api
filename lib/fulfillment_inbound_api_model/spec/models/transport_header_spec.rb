...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::TransportHeader
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransportHeader' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::TransportHeader.new
  end
  ...
  describe 'test an instance of TransportHeader' do
    it 'should create an instance of TransportHeader' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::TransportHeader)
    end
  end
