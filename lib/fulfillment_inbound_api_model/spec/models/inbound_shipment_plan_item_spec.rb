...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlanItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundShipmentPlanItem' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlanItem.new
  end
  ...
  describe 'test an instance of InboundShipmentPlanItem' do
    it 'should create an instance of InboundShipmentPlanItem' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlanItem)
    end
  end
