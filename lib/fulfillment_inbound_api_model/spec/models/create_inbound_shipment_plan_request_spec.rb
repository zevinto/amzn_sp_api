...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::CreateInboundShipmentPlanRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateInboundShipmentPlanRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::CreateInboundShipmentPlanRequest.new
  end
  ...
  describe 'test an instance of CreateInboundShipmentPlanRequest' do
    it 'should create an instance of CreateInboundShipmentPlanRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::CreateInboundShipmentPlanRequest)
    end
  end
