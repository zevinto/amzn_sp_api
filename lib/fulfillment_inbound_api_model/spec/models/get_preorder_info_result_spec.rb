...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::GetPreorderInfoResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetPreorderInfoResult' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::GetPreorderInfoResult.new
  end
  ...
  describe 'test an instance of GetPreorderInfoResult' do
    it 'should create an instance of GetPreorderInfoResult' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::GetPreorderInfoResult)
    end
  end
