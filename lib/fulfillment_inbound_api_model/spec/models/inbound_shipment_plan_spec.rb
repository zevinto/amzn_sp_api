...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InboundShipmentPlan' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlan.new
  end
  ...
  describe 'test an instance of InboundShipmentPlan' do
    it 'should create an instance of InboundShipmentPlan' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::InboundShipmentPlan)
    end
  end
