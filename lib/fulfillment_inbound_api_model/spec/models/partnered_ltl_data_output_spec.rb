...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::PartneredLtlDataOutput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartneredLtlDataOutput' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::PartneredLtlDataOutput.new
  end
  ...
  describe 'test an instance of PartneredLtlDataOutput' do
    it 'should create an instance of PartneredLtlDataOutput' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::PartneredLtlDataOutput)
    end
  end
