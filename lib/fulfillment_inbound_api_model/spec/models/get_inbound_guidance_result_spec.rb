...
# Unit tests for AmznSpApi::FulfillmentInboundApiModel::GetInboundGuidanceResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInboundGuidanceResult' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentInboundApiModel::GetInboundGuidanceResult.new
  end
  ...
  describe 'test an instance of GetInboundGuidanceResult' do
    it 'should create an instance of GetInboundGuidanceResult' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentInboundApiModel::GetInboundGuidanceResult)
    end
  end
