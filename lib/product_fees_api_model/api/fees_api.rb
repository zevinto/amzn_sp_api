...
module AmznSpApi::ProductFeesApiModel
  class FeesApi
    ...
    def get_my_fees_estimate_for_asin_with_http_info(body, asin, opts = {})
      @api_client.config.logger.debug 'Calling API: FeesApi.get_my_fees_estimate_for_asin ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling FeesApi.get_my_fees_estimate_for_asin" if @api_client.config.client_side_validation && body.nil?
      # verify the required parameter 'asin' is set
      raise ArgumentError, "Missing the required parameter 'asin' when calling FeesApi.get_my_fees_estimate_for_asin" if @api_client.config.client_side_validation && asin.nil?
    ...
    def get_my_fees_estimate_for_sku_with_http_info(body, seller_sku, opts = {})
      @api_client.config.logger.debug 'Calling API: FeesApi.get_my_fees_estimate_for_sku ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling FeesApi.get_my_fees_estimate_for_sku" if @api_client.config.client_side_validation && body.nil?
      # verify the required parameter 'seller_sku' is set
      raise ArgumentError, "Missing the required parameter 'seller_sku' when calling FeesApi.get_my_fees_estimate_for_sku" if @api_client.config.client_side_validation && seller_sku.nil?
    ...
    def get_my_fees_estimates_with_http_info(body, opts = {})
      @api_client.config.logger.debug 'Calling API: FeesApi.get_my_fees_estimates ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling FeesApi.get_my_fees_estimates" if @api_client.config.client_side_validation && body.nil?
