...
# Unit tests for AmznSpApi::ProductFeesApiModel::FeesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesApi' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductFeesApiModel::FeesApi.new
  end
  ...
  describe 'test an instance of FeesApi' do
    it 'should create an instance of FeesApi' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductFeesApiModel::FeesApi)
    end
  end
