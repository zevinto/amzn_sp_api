...
# Unit tests for AmznSpApi::ProductFeesApiModel::PriceToEstimateFees
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PriceToEstimateFees' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductFeesApiModel::PriceToEstimateFees.new
  end
  ...
  describe 'test an instance of PriceToEstimateFees' do
    it 'should create an instance of PriceToEstimateFees' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductFeesApiModel::PriceToEstimateFees)
    end
  end
