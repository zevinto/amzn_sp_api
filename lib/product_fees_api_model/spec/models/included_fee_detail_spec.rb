...
# Unit tests for AmznSpApi::ProductFeesApiModel::IncludedFeeDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncludedFeeDetail' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductFeesApiModel::IncludedFeeDetail.new
  end
  ...
  describe 'test an instance of IncludedFeeDetail' do
    it 'should create an instance of IncludedFeeDetail' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductFeesApiModel::IncludedFeeDetail)
    end
  end
