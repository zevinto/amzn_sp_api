...
# Unit tests for AmznSpApi::ProductFeesApiModel::FeesEstimate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeesEstimate' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductFeesApiModel::FeesEstimate.new
  end
  ...
  describe 'test an instance of FeesEstimate' do
    it 'should create an instance of FeesEstimate' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductFeesApiModel::FeesEstimate)
    end
  end
