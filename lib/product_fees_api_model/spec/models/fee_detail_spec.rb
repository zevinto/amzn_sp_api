...
# Unit tests for AmznSpApi::ProductFeesApiModel::FeeDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeDetail' do
  before do
    # run before each test
    @instance = AmznSpApi::ProductFeesApiModel::FeeDetail.new
  end
  ...
  describe 'test an instance of FeeDetail' do
    it 'should create an instance of FeeDetail' do
      expect(@instance).to be_instance_of(AmznSpApi::ProductFeesApiModel::FeeDetail)
    end
  end
