...
module AmznSpApi::ProductFeesApiModel
  ...
  class FeesEstimateIdentifier
    ...
    attr_accessor :id_type, :price_to_estimate_fees, :optional_fulfillment_program
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::ProductFeesApiModel::FeesEstimateIdentifier` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::ProductFeesApiModel::FeesEstimateIdentifier`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.id_type = attributes[:id_type] if attributes.key?(:id_type)

      self.id_value = attributes[:id_value] if attributes.key?(:id_value)

      self.is_amazon_fulfilled = attributes[:is_amazon_fulfilled] if attributes.key?(:is_amazon_fulfilled)

      self.price_to_estimate_fees = attributes[:price_to_estimate_fees] if attributes.key?(:price_to_estimate_fees)

      self.seller_input_identifier = attributes[:seller_input_identifier] if attributes.key?(:seller_input_identifier)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        is_amazon_fulfilled == other.is_amazon_fulfilled &&
        price_to_estimate_fees == other.price_to_estimate_fees &&
        seller_input_identifier == other.seller_input_identifier &&
        optional_fulfillment_program == other.optional_fulfillment_program
    end
