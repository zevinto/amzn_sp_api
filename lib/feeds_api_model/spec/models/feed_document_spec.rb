...
# Unit tests for AmznSpApi::FeedsApiModel::FeedDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeedDocument' do
  before do
    # run before each test
    @instance = AmznSpApi::FeedsApiModel::FeedDocument.new
  end
  ...
  describe 'test an instance of FeedDocument' do
    it 'should create an instance of FeedDocument' do
      expect(@instance).to be_instance_of(AmznSpApi::FeedsApiModel::FeedDocument)
    end
  end
