...
# Unit tests for AmznSpApi::ReportsApiModel::ReportDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportDocument' do
  before do
    # run before each test
    @instance = AmznSpApi::ReportsApiModel::ReportDocument.new
  end
  ...
  describe 'test an instance of ReportDocument' do
    it 'should create an instance of ReportDocument' do
      expect(@instance).to be_instance_of(AmznSpApi::ReportsApiModel::ReportDocument)
    end
  end
