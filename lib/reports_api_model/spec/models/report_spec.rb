...
# Unit tests for AmznSpApi::ReportsApiModel::Report
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Report' do
  before do
    # run before each test
    @instance = AmznSpApi::ReportsApiModel::Report.new
  end
  ...
  describe 'test an instance of Report' do
    it 'should create an instance of Report' do
      expect(@instance).to be_instance_of(AmznSpApi::ReportsApiModel::Report)
    end
  end
