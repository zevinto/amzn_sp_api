...
# Unit tests for AmznSpApi::ReportsApiModel::GetReportsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetReportsResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::ReportsApiModel::GetReportsResponse.new
  end
  ...
  describe 'test an instance of GetReportsResponse' do
    it 'should create an instance of GetReportsResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::ReportsApiModel::GetReportsResponse)
    end
  end
