...
module AmznSpApi::ReportsApiModel
  ...
  class ReportDocument
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::ReportsApiModel::ReportDocument` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::ReportsApiModel::ReportDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)

        h[k.to_sym] = v
      end

      self.report_document_id = attributes[:report_document_id] if attributes.key?(:report_document_id)
    ...
    def list_invalid_properties
      invalid_properties = []
      invalid_properties.push('invalid value for "report_document_id", report_document_id cannot be nil.') if @report_document_id.nil?
    ...
    def compression_algorithm=(compression_algorithm)
      ...
      raise ArgumentError, "invalid value for \"compression_algorithm\", must be one of #{validator.allowable_values}." unless validator.valid?(compression_algorithm)
