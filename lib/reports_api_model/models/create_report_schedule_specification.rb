...
module AmznSpApi::ReportsApiModel
  class CreateReportScheduleSpecification
    ...
    def period=(period)
      validator = EnumAttributeValidator.new('Object', %w[PT5M PT15M PT30M PT1H PT2H PT4H PT8H PT12H P1D P2D P3D PT84H P7D P14D P15D P18D P30D P1M])
      raise ArgumentError, "invalid value for \"period\", must be one of #{validator.allowable_values}." unless validator.valid?(period)
