...
# Unit tests for AmznSpApi::ListingsItemsApiModel::Issue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Issue' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::Issue.new
  end
  ...
  describe 'test an instance of Issue' do
    it 'should create an instance of Issue' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::Issue)
    end
  end
