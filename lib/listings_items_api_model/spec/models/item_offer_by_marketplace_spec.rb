...
# Unit tests for AmznSpApi::ListingsItemsApiModel::ItemOfferByMarketplace
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemOfferByMarketplace' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::ItemOfferByMarketplace.new
  end
  ...
  describe 'test an instance of ItemOfferByMarketplace' do
    it 'should create an instance of ItemOfferByMarketplace' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::ItemOfferByMarketplace)
    end
  end
