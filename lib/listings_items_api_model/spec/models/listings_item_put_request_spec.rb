...
# Unit tests for AmznSpApi::ListingsItemsApiModel::ListingsItemPutRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemPutRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::ListingsItemPutRequest.new
  end
  ...
  describe 'test an instance of ListingsItemPutRequest' do
    it 'should create an instance of ListingsItemPutRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::ListingsItemPutRequest)
    end
  end
