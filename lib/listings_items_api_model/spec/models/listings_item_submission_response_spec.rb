...
# Unit tests for AmznSpApi::ListingsItemsApiModel::ListingsItemSubmissionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsItemSubmissionResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::ListingsItemSubmissionResponse.new
  end
  ...
  describe 'test an instance of ListingsItemSubmissionResponse' do
    it 'should create an instance of ListingsItemSubmissionResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::ListingsItemSubmissionResponse)
    end
  end
