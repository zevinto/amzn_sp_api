...
# Unit tests for AmznSpApi::ListingsItemsApiModel::PatchOperation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PatchOperation' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::PatchOperation.new
  end
  ...
  describe 'test an instance of PatchOperation' do
    it 'should create an instance of PatchOperation' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::PatchOperation)
    end
  end
