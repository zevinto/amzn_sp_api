...
# Unit tests for AmznSpApi::ListingsItemsApiModel::ItemImage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemImage' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::ItemImage.new
  end
  ...
  describe 'test an instance of ItemImage' do
    it 'should create an instance of ItemImage' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::ItemImage)
    end
  end
