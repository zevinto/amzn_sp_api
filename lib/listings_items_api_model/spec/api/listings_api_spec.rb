...
# Unit tests for AmznSpApi::ListingsItemsApiModel::ListingsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListingsApi' do
  before do
    # run before each test
    @instance = AmznSpApi::ListingsItemsApiModel::ListingsApi.new
  end
  ...
  describe 'test an instance of ListingsApi' do
    it 'should create an instance of ListingsApi' do
      expect(@instance).to be_instance_of(AmznSpApi::ListingsItemsApiModel::ListingsApi)
    end
  end
