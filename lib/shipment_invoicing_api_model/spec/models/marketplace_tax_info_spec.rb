...
# Unit tests for AmznSpApi::ShipmentInvoicingApiModel::MarketplaceTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceTaxInfo' do
  before do
    # run before each test
    @instance = AmznSpApi::ShipmentInvoicingApiModel::MarketplaceTaxInfo.new
  end
  ...
  describe 'test an instance of MarketplaceTaxInfo' do
    it 'should create an instance of MarketplaceTaxInfo' do
      expect(@instance).to be_instance_of(AmznSpApi::ShipmentInvoicingApiModel::MarketplaceTaxInfo)
    end
  end
