...
# Unit tests for AmznSpApi::ShipmentInvoicingApiModel::Address
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Address' do
  before do
    # run before each test
    @instance = AmznSpApi::ShipmentInvoicingApiModel::Address.new
  end
  ...
  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(@instance).to be_instance_of(AmznSpApi::ShipmentInvoicingApiModel::Address)
    end
  end
