...
# Unit tests for AmznSpApi::ShipmentInvoicingApiModel::ShipmentDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentDetail' do
  before do
    # run before each test
    @instance = AmznSpApi::ShipmentInvoicingApiModel::ShipmentDetail.new
  end
  ...
  describe 'test an instance of ShipmentDetail' do
    it 'should create an instance of ShipmentDetail' do
      expect(@instance).to be_instance_of(AmznSpApi::ShipmentInvoicingApiModel::ShipmentDetail)
    end
  end
