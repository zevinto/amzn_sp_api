...
# Unit tests for AmznSpApi::ShipmentInvoicingApiModel::ShipmentInvoiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipmentInvoiceApi' do
  before do
    # run before each test
    @instance = AmznSpApi::ShipmentInvoicingApiModel::ShipmentInvoiceApi.new
  end
  ...
  describe 'test an instance of ShipmentInvoiceApi' do
    it 'should create an instance of ShipmentInvoiceApi' do
      expect(@instance).to be_instance_of(AmznSpApi::ShipmentInvoicingApiModel::ShipmentInvoiceApi)
    end
  end
