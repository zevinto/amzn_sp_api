...
module AmznSpApi::ShipmentInvoicingApiModel
  class ShipmentInvoiceApi
    ...
    def get_invoice_status_with_http_info(shipment_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ShipmentInvoiceApi.get_invoice_status ...' if @api_client.config.debugging
      # verify the required parameter 'shipment_id' is set
      raise ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.get_invoice_status" if @api_client.config.client_side_validation && shipment_id.nil?
    ...
    def get_shipment_details_with_http_info(shipment_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ShipmentInvoiceApi.get_shipment_details ...' if @api_client.config.debugging
      # verify the required parameter 'shipment_id' is set
      raise ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.get_shipment_details" if @api_client.config.client_side_validation && shipment_id.nil?
    ...
    def submit_invoice_with_http_info(body, shipment_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ShipmentInvoiceApi.submit_invoice ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling ShipmentInvoiceApi.submit_invoice" if @api_client.config.client_side_validation && body.nil?
      # verify the required parameter 'shipment_id' is set
      raise ArgumentError, "Missing the required parameter 'shipment_id' when calling ShipmentInvoiceApi.submit_invoice" if @api_client.config.client_side_validation && shipment_id.nil?
