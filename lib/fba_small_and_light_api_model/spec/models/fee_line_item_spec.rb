...
# Unit tests for AmznSpApi::FbaSmallAndLightApiModel::FeeLineItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeLineItem' do
  before do
    # run before each test
    @instance = AmznSpApi::FbaSmallAndLightApiModel::FeeLineItem.new
  end
  ...
  describe 'test an instance of FeeLineItem' do
    it 'should create an instance of FeeLineItem' do
      expect(@instance).to be_instance_of(AmznSpApi::FbaSmallAndLightApiModel::FeeLineItem)
    end
  end
