...
# Unit tests for AmznSpApi::FbaSmallAndLightApiModel::SmallAndLightApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmallAndLightApi' do
  before do
    # run before each test
    @instance = AmznSpApi::FbaSmallAndLightApiModel::SmallAndLightApi.new
  end
  ...
  describe 'test an instance of SmallAndLightApi' do
    it 'should create an instance of SmallAndLightApi' do
      expect(@instance).to be_instance_of(AmznSpApi::FbaSmallAndLightApiModel::SmallAndLightApi)
    end
  end
