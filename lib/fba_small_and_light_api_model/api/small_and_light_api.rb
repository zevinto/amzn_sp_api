...
module AmznSpApi::FbaSmallAndLightApiModel
  class SmallAndLightApi
    ...
    def delete_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku ...' if @api_client.config.debugging
      # verify the required parameter 'seller_sku' is set
      raise ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.delete_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && marketplace_ids.nil?
    ...
    def get_small_and_light_eligibility_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku ...' if @api_client.config.debugging
      # verify the required parameter 'seller_sku' is set
      raise ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku" if @api_client.config.client_side_validation && seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.get_small_and_light_eligibility_by_seller_sku" if @api_client.config.client_side_validation && marketplace_ids.nil?
    ...
    def get_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku ...' if @api_client.config.debugging
      # verify the required parameter 'seller_sku' is set
      raise ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.get_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && marketplace_ids.nil?
    ...
    def get_small_and_light_fee_preview_with_http_info(body, opts = {})
      @api_client.config.logger.debug 'Calling API: SmallAndLightApi.get_small_and_light_fee_preview ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling SmallAndLightApi.get_small_and_light_fee_preview" if @api_client.config.client_side_validation && body.nil?
    ...
    def put_small_and_light_enrollment_by_seller_sku_with_http_info(seller_sku, marketplace_ids, opts = {})
      @api_client.config.logger.debug 'Calling API: SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku ...' if @api_client.config.debugging
      # verify the required parameter 'seller_sku' is set
      raise ArgumentError, "Missing the required parameter 'seller_sku' when calling SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && seller_sku.nil?
      # verify the required parameter 'marketplace_ids' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_ids' when calling SmallAndLightApi.put_small_and_light_enrollment_by_seller_sku" if @api_client.config.client_side_validation && marketplace_ids.nil?
