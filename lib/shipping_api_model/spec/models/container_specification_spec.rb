...
# Unit tests for AmznSpApi::ShippingApiModel::ContainerSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContainerSpecification' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::ContainerSpecification.new
  end
  ...
  describe 'test an instance of ContainerSpecification' do
    it 'should create an instance of ContainerSpecification' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::ContainerSpecification)
    end
  end
