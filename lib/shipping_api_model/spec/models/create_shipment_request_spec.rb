...
# Unit tests for AmznSpApi::ShippingApiModel::CreateShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateShipmentRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::CreateShipmentRequest.new
  end
  ...
  describe 'test an instance of CreateShipmentRequest' do
    it 'should create an instance of CreateShipmentRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::CreateShipmentRequest)
    end
  end
