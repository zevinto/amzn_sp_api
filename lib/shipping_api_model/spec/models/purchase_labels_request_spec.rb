...
# Unit tests for AmznSpApi::ShippingApiModel::PurchaseLabelsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelsRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::PurchaseLabelsRequest.new
  end
  ...
  describe 'test an instance of PurchaseLabelsRequest' do
    it 'should create an instance of PurchaseLabelsRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::PurchaseLabelsRequest)
    end
  end
