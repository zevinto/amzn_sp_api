...
# Unit tests for AmznSpApi::ShippingApiModel::LabelSpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelSpecification' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::LabelSpecification.new
  end
  ...
  describe 'test an instance of LabelSpecification' do
    it 'should create an instance of LabelSpecification' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::LabelSpecification)
    end
  end
