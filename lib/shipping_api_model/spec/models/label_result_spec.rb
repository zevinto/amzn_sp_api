...
# Unit tests for AmznSpApi::ShippingApiModel::LabelResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelResult' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::LabelResult.new
  end
  ...
  describe 'test an instance of LabelResult' do
    it 'should create an instance of LabelResult' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::LabelResult)
    end
  end
