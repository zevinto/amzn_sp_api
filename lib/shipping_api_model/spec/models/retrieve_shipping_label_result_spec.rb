...
# Unit tests for AmznSpApi::ShippingApiModel::RetrieveShippingLabelResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RetrieveShippingLabelResult' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::RetrieveShippingLabelResult.new
  end
  ...
  describe 'test an instance of RetrieveShippingLabelResult' do
    it 'should create an instance of RetrieveShippingLabelResult' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::RetrieveShippingLabelResult)
    end
  end
