...
# Unit tests for AmznSpApi::ShippingApiModel::Container
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Container' do
  before do
    # run before each test
    @instance = AmznSpApi::ShippingApiModel::Container.new
  end
  ...
  describe 'test an instance of Container' do
    it 'should create an instance of Container' do
      expect(@instance).to be_instance_of(AmznSpApi::ShippingApiModel::Container)
    end
  end
