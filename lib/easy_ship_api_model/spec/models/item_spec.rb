...
# Unit tests for AmznSpApi::EasyShipApiModel::Item
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Item' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipApiModel::Item.new
  end
  ...
  describe 'test an instance of Item' do
    it 'should create an instance of Item' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipApiModel::Item)
    end
  end
