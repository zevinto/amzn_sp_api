...
# Unit tests for AmznSpApi::EasyShipApiModel::InvoiceData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceData' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipApiModel::InvoiceData.new
  end
  ...
  describe 'test an instance of InvoiceData' do
    it 'should create an instance of InvoiceData' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipApiModel::InvoiceData)
    end
  end
