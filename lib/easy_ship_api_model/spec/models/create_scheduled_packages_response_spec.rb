...
# Unit tests for AmznSpApi::EasyShipApiModel::CreateScheduledPackagesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateScheduledPackagesResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipApiModel::CreateScheduledPackagesResponse.new
  end
  ...
  describe 'test an instance of CreateScheduledPackagesResponse' do
    it 'should create an instance of CreateScheduledPackagesResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipApiModel::CreateScheduledPackagesResponse)
    end
  end
