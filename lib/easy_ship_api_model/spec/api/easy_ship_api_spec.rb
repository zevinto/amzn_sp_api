...
# Unit tests for AmznSpApi::EasyShipApiModel::EasyShipApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EasyShipApi' do
  before do
    # run before each test
    @instance = AmznSpApi::EasyShipApiModel::EasyShipApi.new
  end
  ...
  describe 'test an instance of EasyShipApi' do
    it 'should create an instance of EasyShipApi' do
      expect(@instance).to be_instance_of(AmznSpApi::EasyShipApiModel::EasyShipApi)
    end
  end
