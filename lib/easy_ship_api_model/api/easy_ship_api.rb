...
module AmznSpApi::EasyShipApiModel
  class EasyShipApi
    ...
    def create_scheduled_package_with_http_info(body, opts = {})
      @api_client.config.logger.debug 'Calling API: EasyShipApi.create_scheduled_package ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling EasyShipApi.create_scheduled_package" if @api_client.config.client_side_validation && body.nil?
    ...
    def create_scheduled_package_bulk_with_http_info(body, opts = {})
      @api_client.config.logger.debug 'Calling API: EasyShipApi.create_scheduled_package_bulk ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling EasyShipApi.create_scheduled_package_bulk" if @api_client.config.client_side_validation && body.nil?
    ...
    def get_scheduled_package_with_http_info(amazon_order_id, marketplace_id, opts = {})
      @api_client.config.logger.debug 'Calling API: EasyShipApi.get_scheduled_package ...' if @api_client.config.debugging
      # verify the required parameter 'amazon_order_id' is set
      raise ArgumentError, "Missing the required parameter 'amazon_order_id' when calling EasyShipApi.get_scheduled_package" if @api_client.config.client_side_validation && amazon_order_id.nil?
      # verify the required parameter 'marketplace_id' is set
      raise ArgumentError, "Missing the required parameter 'marketplace_id' when calling EasyShipApi.get_scheduled_package" if @api_client.config.client_side_validation && marketplace_id.nil?
    ...
    def list_handover_slots_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: EasyShipApi.list_handover_slots ...' if @api_client.config.debugging
      # resource path
    ...
    def update_scheduled_packages_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: EasyShipApi.update_scheduled_packages ...' if @api_client.config.debugging
      # resource path
      local_var_path = '/easyShip/2022-03-23/package'
