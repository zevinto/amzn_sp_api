...
module AmznSpApi::EasyShipApiModel
  ...
  class CreateScheduledPackageRequest
    attr_accessor :amazon_order_id, :marketplace_id, :package_details
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::EasyShipApiModel::CreateScheduledPackageRequest` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::EasyShipApiModel::CreateScheduledPackageRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:package_details)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "package_details", package_details cannot be nil.') if @package_details.nil?
