...
# Unit tests for AmznSpApi::FbaInventoryApiModel::FbaInventoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FbaInventoryApi' do
  before do
    # run before each test
    @instance = AmznSpApi::FbaInventoryApiModel::FbaInventoryApi.new
  end
  ...
  describe 'test an instance of FbaInventoryApi' do
    it 'should create an instance of FbaInventoryApi' do
      expect(@instance).to be_instance_of(AmznSpApi::FbaInventoryApiModel::FbaInventoryApi)
    end
  end
