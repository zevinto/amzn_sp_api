...
# Unit tests for AmznSpApi::TokensApiModel::RestrictedResource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestrictedResource' do
  before do
    # run before each test
    @instance = AmznSpApi::TokensApiModel::RestrictedResource.new
  end
  ...
  describe 'test an instance of RestrictedResource' do
    it 'should create an instance of RestrictedResource' do
      expect(@instance).to be_instance_of(AmznSpApi::TokensApiModel::RestrictedResource)
    end
  end
