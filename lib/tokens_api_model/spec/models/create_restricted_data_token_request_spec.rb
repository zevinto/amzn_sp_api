...
# Unit tests for AmznSpApi::TokensApiModel::CreateRestrictedDataTokenRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateRestrictedDataTokenRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::TokensApiModel::CreateRestrictedDataTokenRequest.new
  end
  ...
  describe 'test an instance of CreateRestrictedDataTokenRequest' do
    it 'should create an instance of CreateRestrictedDataTokenRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::TokensApiModel::CreateRestrictedDataTokenRequest)
    end
  end
