...
# Unit tests for AmznSpApi::SellersApiModel::SellersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellersApi' do
  before do
    # run before each test
    @instance = AmznSpApi::SellersApiModel::SellersApi.new
  end
  ...
  describe 'test an instance of SellersApi' do
    it 'should create an instance of SellersApi' do
      expect(@instance).to be_instance_of(AmznSpApi::SellersApiModel::SellersApi)
    end
  end
