...
# Unit tests for AmznSpApi::SellersApiModel::MarketplaceParticipation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceParticipation' do
  before do
    # run before each test
    @instance = AmznSpApi::SellersApiModel::MarketplaceParticipation.new
  end
  ...
  describe 'test an instance of MarketplaceParticipation' do
    it 'should create an instance of MarketplaceParticipation' do
      expect(@instance).to be_instance_of(AmznSpApi::SellersApiModel::MarketplaceParticipation)
    end
  end
