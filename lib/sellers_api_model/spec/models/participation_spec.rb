...
# Unit tests for AmznSpApi::SellersApiModel::Participation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Participation' do
  before do
    # run before each test
    @instance = AmznSpApi::SellersApiModel::Participation.new
  end
  ...
  describe 'test an instance of Participation' do
    it 'should create an instance of Participation' do
      expect(@instance).to be_instance_of(AmznSpApi::SellersApiModel::Participation)
    end
  end
