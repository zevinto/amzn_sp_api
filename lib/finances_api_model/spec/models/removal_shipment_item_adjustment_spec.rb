...
# Unit tests for AmznSpApi::FinancesApiModel::RemovalShipmentItemAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemovalShipmentItemAdjustment' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::RemovalShipmentItemAdjustment.new
  end
  ...
  describe 'test an instance of RemovalShipmentItemAdjustment' do
    it 'should create an instance of RemovalShipmentItemAdjustment' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::RemovalShipmentItemAdjustment)
    end
  end
