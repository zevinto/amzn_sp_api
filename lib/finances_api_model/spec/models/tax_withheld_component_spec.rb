...
# Unit tests for AmznSpApi::FinancesApiModel::TaxWithheldComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TaxWithheldComponent' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::TaxWithheldComponent.new
  end
  ...
  describe 'test an instance of TaxWithheldComponent' do
    it 'should create an instance of TaxWithheldComponent' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::TaxWithheldComponent)
    end
  end
