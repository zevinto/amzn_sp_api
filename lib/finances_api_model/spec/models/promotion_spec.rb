...
# Unit tests for AmznSpApi::FinancesApiModel::Promotion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Promotion' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::Promotion.new
  end
  ...
  describe 'test an instance of Promotion' do
    it 'should create an instance of Promotion' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::Promotion)
    end
  end
