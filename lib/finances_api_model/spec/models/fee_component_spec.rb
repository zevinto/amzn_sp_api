...
# Unit tests for AmznSpApi::FinancesApiModel::FeeComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeComponent' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::FeeComponent.new
  end
  ...
  describe 'test an instance of FeeComponent' do
    it 'should create an instance of FeeComponent' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::FeeComponent)
    end
  end
