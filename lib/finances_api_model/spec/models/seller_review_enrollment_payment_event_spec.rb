...
# Unit tests for AmznSpApi::FinancesApiModel::SellerReviewEnrollmentPaymentEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SellerReviewEnrollmentPaymentEvent' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::SellerReviewEnrollmentPaymentEvent.new
  end
  ...
  describe 'test an instance of SellerReviewEnrollmentPaymentEvent' do
    it 'should create an instance of SellerReviewEnrollmentPaymentEvent' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::SellerReviewEnrollmentPaymentEvent)
    end
  end
