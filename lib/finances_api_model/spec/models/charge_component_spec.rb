...
# Unit tests for AmznSpApi::FinancesApiModel::ChargeComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChargeComponent' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::ChargeComponent.new
  end
  ...
  describe 'test an instance of ChargeComponent' do
    it 'should create an instance of ChargeComponent' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::ChargeComponent)
    end
  end
