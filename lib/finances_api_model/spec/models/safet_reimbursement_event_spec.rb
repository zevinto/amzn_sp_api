...
# Unit tests for AmznSpApi::FinancesApiModel::SAFETReimbursementEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SAFETReimbursementEvent' do
  before do
    # run before each test
    @instance = AmznSpApi::FinancesApiModel::SAFETReimbursementEvent.new
  end
  ...
  describe 'test an instance of SAFETReimbursementEvent' do
    it 'should create an instance of SAFETReimbursementEvent' do
      expect(@instance).to be_instance_of(AmznSpApi::FinancesApiModel::SAFETReimbursementEvent)
    end
  end
