...
module AmznSpApi::FinancesApiModel
  ...
  class CouponPaymentEvent
    attr_accessor :posted_date, :fee_component, :charge_component, :total_amount
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FinancesApiModel::CouponPaymentEvent` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FinancesApiModel::CouponPaymentEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.coupon_id = attributes[:coupon_id] if attributes.key?(:coupon_id)

      self.seller_coupon_description = attributes[:seller_coupon_description] if attributes.key?(:seller_coupon_description)

      self.clip_or_redemption_count = attributes[:clip_or_redemption_count] if attributes.key?(:clip_or_redemption_count)

      self.payment_event_id = attributes[:payment_event_id] if attributes.key?(:payment_event_id)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        seller_coupon_description == other.seller_coupon_description &&
        clip_or_redemption_count == other.clip_or_redemption_count &&
        payment_event_id == other.payment_event_id &&
