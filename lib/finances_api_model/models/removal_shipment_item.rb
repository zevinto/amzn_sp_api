...
module AmznSpApi::FinancesApiModel
  ...
  class RemovalShipmentItem
    ...
    attr_accessor :revenue, :fee_amount, :tax_amount, :tax_withheld
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FinancesApiModel::RemovalShipmentItem` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FinancesApiModel::RemovalShipmentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:tax_withheld)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        tax_withheld == other.tax_withheld
    end
