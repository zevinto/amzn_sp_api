...
module AmznSpApi::FinancesApiModel
  ...
  class RetrochargeEvent
    ...
    attr_accessor :posted_date, :base_tax, :shipping_tax, :retrocharge_tax_withheld_list
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FinancesApiModel::RetrochargeEvent` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FinancesApiModel::RetrochargeEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)

        h[k.to_sym] = v
      end

      self.retrocharge_event_type = attributes[:retrocharge_event_type] if attributes.key?(:retrocharge_event_type)
      ...
      self.base_tax = attributes[:base_tax] if attributes.key?(:base_tax)
      ...
      return unless attributes.key?(:retrocharge_tax_withheld_list)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        retrocharge_event_type == other.retrocharge_event_type &&
        amazon_order_id == other.amazon_order_id &&
        posted_date == other.posted_date &&
        base_tax == other.base_tax &&
        shipping_tax == other.shipping_tax &&
        marketplace_name == other.marketplace_name &&
        retrocharge_tax_withheld_list == other.retrocharge_tax_withheld_list
    end
