...
module AmznSpApi::FinancesApiModel
  ...
  class ShipmentEvent
    ...
    attr_accessor :order_charge_list, :order_charge_adjustment_list, :shipment_fee_list, :shipment_fee_adjustment_list, :order_fee_list, :order_fee_adjustment_list, :direct_payment_list, :posted_date, :shipment_item_list, :shipment_item_adjustment_list
