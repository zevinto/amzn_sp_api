...
module AmznSpApi::FinancesApiModel
  ...
  class AffordabilityExpenseEvent
    ...
    attr_accessor :posted_date, :base_expense, :tax_type_cgst, :tax_type_sgst, :tax_type_igst, :total_expense
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FinancesApiModel::AffordabilityExpenseEvent` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FinancesApiModel::AffordabilityExpenseEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.base_expense = attributes[:base_expense] if attributes.key?(:base_expense)

      self.tax_type_cgst = attributes[:tax_type_cgst] if attributes.key?(:tax_type_cgst)

      self.tax_type_sgst = attributes[:tax_type_sgst] if attributes.key?(:tax_type_sgst)

      self.tax_type_igst = attributes[:tax_type_igst] if attributes.key?(:tax_type_igst)

      return unless attributes.key?(:total_expense)
    ...
    def list_invalid_properties
      invalid_properties = []
      invalid_properties.push('invalid value for "tax_type_cgst", tax_type_cgst cannot be nil.') if @tax_type_cgst.nil?

      invalid_properties.push('invalid value for "tax_type_sgst", tax_type_sgst cannot be nil.') if @tax_type_sgst.nil?

      invalid_properties.push('invalid value for "tax_type_igst", tax_type_igst cannot be nil.') if @tax_type_igst.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        base_expense == other.base_expense &&
        tax_type_cgst == other.tax_type_cgst &&
        tax_type_sgst == other.tax_type_sgst &&
        tax_type_igst == other.tax_type_igst &&
