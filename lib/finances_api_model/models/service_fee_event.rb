...
module AmznSpApi::FinancesApiModel
  ...
  class ServiceFeeEvent
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FinancesApiModel::ServiceFeeEvent` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FinancesApiModel::ServiceFeeEvent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.fee_reason = attributes[:fee_reason] if attributes.key?(:fee_reason)
      ...
      self.fee_description = attributes[:fee_description] if attributes.key?(:fee_description)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        fee_reason == other.fee_reason &&
        fee_list == other.fee_list &&
        seller_sku == other.seller_sku &&
        fn_sku == other.fn_sku &&
        fee_description == other.fee_description &&
        asin == other.asin
    end
