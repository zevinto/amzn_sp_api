...
# Unit tests for AmznSpApi::AplusContentApiModel::SearchContentDocumentsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchContentDocumentsResponse' do
  before do
    # run before each test
    @instance = AmznSpApi::AplusContentApiModel::SearchContentDocumentsResponse.new
  end
  ...
  describe 'test an instance of SearchContentDocumentsResponse' do
    it 'should create an instance of SearchContentDocumentsResponse' do
      expect(@instance).to be_instance_of(AmznSpApi::AplusContentApiModel::SearchContentDocumentsResponse)
    end
  end
