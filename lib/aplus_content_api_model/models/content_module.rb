...
module AmznSpApi::AplusContentApiModel
  ...
  class ContentModule
    ...
    def initialize(attributes = {})
      ...
      self.standard_company_logo = attributes[:standard_company_logo] if attributes.key?(:standard_company_logo)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        standard_company_logo == other.standard_company_logo &&
