...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::FbaOutboundApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FbaOutboundApi' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::FbaOutboundApi.new
  end
  ...
  describe 'test an instance of FbaOutboundApi' do
    it 'should create an instance of FbaOutboundApi' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::FbaOutboundApi)
    end
  end
