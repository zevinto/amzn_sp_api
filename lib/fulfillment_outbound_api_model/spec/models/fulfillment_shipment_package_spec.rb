...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentPackage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentShipmentPackage' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentPackage.new
  end
  ...
  describe 'test an instance of FulfillmentShipmentPackage' do
    it 'should create an instance of FulfillmentShipmentPackage' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::FulfillmentShipmentPackage)
    end
  end
