...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::Weight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::Weight.new
  end
  ...
  describe 'test an instance of Weight' do
    it 'should create an instance of Weight' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::Weight)
    end
  end
