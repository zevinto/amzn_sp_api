...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentPreviewItem' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewItem.new
  end
  ...
  describe 'test an instance of FulfillmentPreviewItem' do
    it 'should create an instance of FulfillmentPreviewItem' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewItem)
    end
  end
