...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::CreateReturnItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateReturnItem' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::CreateReturnItem.new
  end
  ...
  describe 'test an instance of CreateReturnItem' do
    it 'should create an instance of CreateReturnItem' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::CreateReturnItem)
    end
  end
