...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::GetFeatureSkuResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFeatureSkuResult' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::GetFeatureSkuResult.new
  end
  ...
  describe 'test an instance of GetFeatureSkuResult' do
    it 'should create an instance of GetFeatureSkuResult' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::GetFeatureSkuResult)
    end
  end
