...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::FeatureSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeatureSettings' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::FeatureSettings.new
  end
  ...
  describe 'test an instance of FeatureSettings' do
    it 'should create an instance of FeatureSettings' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::FeatureSettings)
    end
  end
