...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::CreateFulfillmentReturnResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFulfillmentReturnResult' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::CreateFulfillmentReturnResult.new
  end
  ...
  describe 'test an instance of CreateFulfillmentReturnResult' do
    it 'should create an instance of CreateFulfillmentReturnResult' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::CreateFulfillmentReturnResult)
    end
  end
