...
# Unit tests for AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewShipment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FulfillmentPreviewShipment' do
  before do
    # run before each test
    @instance = AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewShipment.new
  end
  ...
  describe 'test an instance of FulfillmentPreviewShipment' do
    it 'should create an instance of FulfillmentPreviewShipment' do
      expect(@instance).to be_instance_of(AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewShipment)
    end
  end
