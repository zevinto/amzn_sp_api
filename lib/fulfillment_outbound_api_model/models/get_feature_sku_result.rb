...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class GetFeatureSkuResult
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentOutboundApiModel::GetFeatureSkuResult` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentOutboundApiModel::GetFeatureSkuResult`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.is_eligible = attributes[:is_eligible] if attributes.key?(:is_eligible)

      if attributes.key?(:ineligible_reasons) && (value = attributes[:ineligible_reasons]).is_a?(Array)
        self.ineligible_reasons = value
      end

      return unless attributes.key?(:sku_info)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "is_eligible", is_eligible cannot be nil.') if @is_eligible.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        ineligible_reasons == other.ineligible_reasons &&
        sku_info == other.sku_info
    end
