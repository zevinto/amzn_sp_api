...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class FulfillmentPreviewItem
    ...
    attr_accessor :quantity, :estimated_shipping_weight
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewItem` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentOutboundApiModel::FulfillmentPreviewItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:shipping_weight_calculation_method)
    ...
    def valid?
      ...
      shipping_weight_calculation_method_validator = EnumAttributeValidator.new('Object', %w[Package Dimensional])
    ...
    def shipping_weight_calculation_method=(shipping_weight_calculation_method)
      validator = EnumAttributeValidator.new('Object', %w[Package Dimensional])
      raise ArgumentError, "invalid value for \"shipping_weight_calculation_method\", must be one of #{validator.allowable_values}." unless validator.valid?(shipping_weight_calculation_method)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        shipping_weight_calculation_method == other.shipping_weight_calculation_method
    end
