...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class CreateReturnItem
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentOutboundApiModel::CreateReturnItem` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentOutboundApiModel::CreateReturnItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.return_reason_code = attributes[:return_reason_code] if attributes.key?(:return_reason_code)

      return unless attributes.key?(:return_comment)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "return_reason_code", return_reason_code cannot be nil.') if @return_reason_code.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        return_reason_code == other.return_reason_code &&
