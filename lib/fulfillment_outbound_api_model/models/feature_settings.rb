...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class FeatureSettings
    ...
    def feature_fulfillment_policy=(feature_fulfillment_policy)
      validator = EnumAttributeValidator.new('Object', %w[Required NotRequired])
      raise ArgumentError, "invalid value for \"feature_fulfillment_policy\", must be one of #{validator.allowable_values}." unless validator.valid?(feature_fulfillment_policy)
