...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class FulfillmentShipment
    ...
    attr_accessor :shipping_date, :estimated_arrival_date, :fulfillment_shipment_item, :fulfillment_shipment_package
    ...
    def fulfillment_shipment_status=(fulfillment_shipment_status)
      validator = EnumAttributeValidator.new('Object', %w[PENDING SHIPPED CANCELLED_BY_FULFILLER CANCELLED_BY_SELLER])
      raise ArgumentError, "invalid value for \"fulfillment_shipment_status\", must be one of #{validator.allowable_values}." unless validator.valid?(fulfillment_shipment_status)
