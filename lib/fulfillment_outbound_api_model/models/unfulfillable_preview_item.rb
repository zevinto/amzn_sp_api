...
module AmznSpApi::FulfillmentOutboundApiModel
  ...
  class UnfulfillablePreviewItem
    ...
    attr_accessor :quantity, :item_unfulfillable_reasons
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::FulfillmentOutboundApiModel::UnfulfillablePreviewItem` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::FulfillmentOutboundApiModel::UnfulfillablePreviewItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:item_unfulfillable_reasons)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        item_unfulfillable_reasons == other.item_unfulfillable_reasons
    end
