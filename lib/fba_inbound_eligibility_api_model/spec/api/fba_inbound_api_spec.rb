...
# Unit tests for AmznSpApi::FbaInboundEligibilityApiModel::FbaInboundApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FbaInboundApi' do
  before do
    # run before each test
    @instance = AmznSpApi::FbaInboundEligibilityApiModel::FbaInboundApi.new
  end
  ...
  describe 'test an instance of FbaInboundApi' do
    it 'should create an instance of FbaInboundApi' do
      expect(@instance).to be_instance_of(AmznSpApi::FbaInboundEligibilityApiModel::FbaInboundApi)
    end
  end
