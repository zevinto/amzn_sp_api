...
# Unit tests for AmznSpApi::FbaInboundEligibilityApiModel::ItemEligibilityPreview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemEligibilityPreview' do
  before do
    # run before each test
    @instance = AmznSpApi::FbaInboundEligibilityApiModel::ItemEligibilityPreview.new
  end
  ...
  describe 'test an instance of ItemEligibilityPreview' do
    it 'should create an instance of ItemEligibilityPreview' do
      expect(@instance).to be_instance_of(AmznSpApi::FbaInboundEligibilityApiModel::ItemEligibilityPreview)
    end
  end
