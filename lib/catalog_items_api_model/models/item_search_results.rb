...
module AmznSpApi::CatalogItemsApiModel
  ...
  class ItemSearchResults
    ...
    attr_accessor :pagination, :refinements
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::CatalogItemsApiModel::ItemSearchResults` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::CatalogItemsApiModel::ItemSearchResults`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      self.refinements = attributes[:refinements] if attributes.key?(:refinements)
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "pagination", pagination cannot be nil.') if @pagination.nil?

      invalid_properties.push('invalid value for "refinements", refinements cannot be nil.') if @refinements.nil?
