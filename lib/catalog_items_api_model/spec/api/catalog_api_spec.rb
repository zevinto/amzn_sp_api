...
# Unit tests for AmznSpApi::CatalogItemsApiModel::CatalogApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CatalogApi' do
  before do
    # run before each test
    @instance = AmznSpApi::CatalogItemsApiModel::CatalogApi.new
  end
  ...
  describe 'test an instance of CatalogApi' do
    it 'should create an instance of CatalogApi' do
      expect(@instance).to be_instance_of(AmznSpApi::CatalogItemsApiModel::CatalogApi)
    end
  end
