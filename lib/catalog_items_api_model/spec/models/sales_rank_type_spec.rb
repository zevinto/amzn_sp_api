...
# Unit tests for AmznSpApi::CatalogItemsApiModel::SalesRankType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalesRankType' do
  before do
    # run before each test
    @instance = AmznSpApi::CatalogItemsApiModel::SalesRankType.new
  end
  ...
  describe 'test an instance of SalesRankType' do
    it 'should create an instance of SalesRankType' do
      expect(@instance).to be_instance_of(AmznSpApi::CatalogItemsApiModel::SalesRankType)
    end
  end
