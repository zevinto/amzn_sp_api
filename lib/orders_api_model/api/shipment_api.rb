...
module AmznSpApi::OrdersApiModel
  class ShipmentApi
    ...
    def update_shipment_status_with_http_info(body, order_id, opts = {})
      @api_client.config.logger.debug 'Calling API: ShipmentApi.update_shipment_status ...' if @api_client.config.debugging
      # verify the required parameter 'body' is set
      raise ArgumentError, "Missing the required parameter 'body' when calling ShipmentApi.update_shipment_status" if @api_client.config.client_side_validation && body.nil?
      # verify the required parameter 'order_id' is set
      raise ArgumentError, "Missing the required parameter 'order_id' when calling ShipmentApi.update_shipment_status" if @api_client.config.client_side_validation && order_id.nil?
