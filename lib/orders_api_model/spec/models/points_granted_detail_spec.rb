...
# Unit tests for AmznSpApi::OrdersApiModel::PointsGrantedDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PointsGrantedDetail' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::PointsGrantedDetail.new
  end
  ...
  describe 'test an instance of PointsGrantedDetail' do
    it 'should create an instance of PointsGrantedDetail' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::PointsGrantedDetail)
    end
  end
