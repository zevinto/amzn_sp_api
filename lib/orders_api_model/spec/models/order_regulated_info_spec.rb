...
# Unit tests for AmznSpApi::OrdersApiModel::OrderRegulatedInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderRegulatedInfo' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::OrderRegulatedInfo.new
  end
  ...
  describe 'test an instance of OrderRegulatedInfo' do
    it 'should create an instance of OrderRegulatedInfo' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::OrderRegulatedInfo)
    end
  end
