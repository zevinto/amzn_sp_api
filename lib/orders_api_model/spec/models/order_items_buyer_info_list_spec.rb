...
# Unit tests for AmznSpApi::OrdersApiModel::OrderItemsBuyerInfoList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemsBuyerInfoList' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::OrderItemsBuyerInfoList.new
  end
  ...
  describe 'test an instance of OrderItemsBuyerInfoList' do
    it 'should create an instance of OrderItemsBuyerInfoList' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::OrderItemsBuyerInfoList)
    end
  end
