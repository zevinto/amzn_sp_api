...
# Unit tests for AmznSpApi::OrdersApiModel::ItemBuyerInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemBuyerInfo' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::ItemBuyerInfo.new
  end
  ...
  describe 'test an instance of ItemBuyerInfo' do
    it 'should create an instance of ItemBuyerInfo' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::ItemBuyerInfo)
    end
  end
