...
# Unit tests for AmznSpApi::OrdersApiModel::OrderItemsList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderItemsList' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::OrderItemsList.new
  end
  ...
  describe 'test an instance of OrderItemsList' do
    it 'should create an instance of OrderItemsList' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::OrderItemsList)
    end
  end
