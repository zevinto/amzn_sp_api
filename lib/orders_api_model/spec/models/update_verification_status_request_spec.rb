...
# Unit tests for AmznSpApi::OrdersApiModel::UpdateVerificationStatusRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateVerificationStatusRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::UpdateVerificationStatusRequest.new
  end
  ...
  describe 'test an instance of UpdateVerificationStatusRequest' do
    it 'should create an instance of UpdateVerificationStatusRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::UpdateVerificationStatusRequest)
    end
  end
