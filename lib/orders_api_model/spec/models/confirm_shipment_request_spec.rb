...
# Unit tests for AmznSpApi::OrdersApiModel::ConfirmShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConfirmShipmentRequest' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::ConfirmShipmentRequest.new
  end
  ...
  describe 'test an instance of ConfirmShipmentRequest' do
    it 'should create an instance of ConfirmShipmentRequest' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::ConfirmShipmentRequest)
    end
  end
