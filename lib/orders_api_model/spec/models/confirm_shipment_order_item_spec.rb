...
# Unit tests for AmznSpApi::OrdersApiModel::ConfirmShipmentOrderItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConfirmShipmentOrderItem' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::ConfirmShipmentOrderItem.new
  end
  ...
  describe 'test an instance of ConfirmShipmentOrderItem' do
    it 'should create an instance of ConfirmShipmentOrderItem' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::ConfirmShipmentOrderItem)
    end
  end
