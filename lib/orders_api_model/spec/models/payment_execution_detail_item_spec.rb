...
# Unit tests for AmznSpApi::OrdersApiModel::PaymentExecutionDetailItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentExecutionDetailItem' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::PaymentExecutionDetailItem.new
  end
  ...
  describe 'test an instance of PaymentExecutionDetailItem' do
    it 'should create an instance of PaymentExecutionDetailItem' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::PaymentExecutionDetailItem)
    end
  end
