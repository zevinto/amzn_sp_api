...
# Unit tests for AmznSpApi::OrdersApiModel::PackageDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageDetail' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::PackageDetail.new
  end
  ...
  describe 'test an instance of PackageDetail' do
    it 'should create an instance of PackageDetail' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::PackageDetail)
    end
  end
