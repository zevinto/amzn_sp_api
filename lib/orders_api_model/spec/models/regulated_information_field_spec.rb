...
# Unit tests for AmznSpApi::OrdersApiModel::RegulatedInformationField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegulatedInformationField' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::RegulatedInformationField.new
  end
  ...
  describe 'test an instance of RegulatedInformationField' do
    it 'should create an instance of RegulatedInformationField' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::RegulatedInformationField)
    end
  end
