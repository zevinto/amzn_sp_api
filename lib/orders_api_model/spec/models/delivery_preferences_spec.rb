...
# Unit tests for AmznSpApi::OrdersApiModel::DeliveryPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeliveryPreferences' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::DeliveryPreferences.new
  end
  ...
  describe 'test an instance of DeliveryPreferences' do
    it 'should create an instance of DeliveryPreferences' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::DeliveryPreferences)
    end
  end
