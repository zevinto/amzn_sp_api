...
# Unit tests for AmznSpApi::OrdersApiModel::BuyerTaxInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerTaxInfo' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::BuyerTaxInfo.new
  end
  ...
  describe 'test an instance of BuyerTaxInfo' do
    it 'should create an instance of BuyerTaxInfo' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::BuyerTaxInfo)
    end
  end
