...
# Unit tests for AmznSpApi::OrdersApiModel::BuyerTaxInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BuyerTaxInformation' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::BuyerTaxInformation.new
  end
  ...
  describe 'test an instance of BuyerTaxInformation' do
    it 'should create an instance of BuyerTaxInformation' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::BuyerTaxInformation)
    end
  end
