...
# Unit tests for AmznSpApi::OrdersApiModel::BusinessHours
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BusinessHours' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::BusinessHours.new
  end
  ...
  describe 'test an instance of BusinessHours' do
    it 'should create an instance of BusinessHours' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::BusinessHours)
    end
  end
