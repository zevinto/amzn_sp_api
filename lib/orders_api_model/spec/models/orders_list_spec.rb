...
# Unit tests for AmznSpApi::OrdersApiModel::OrdersList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersList' do
  before do
    # run before each test
    @instance = AmznSpApi::OrdersApiModel::OrdersList.new
  end
  ...
  describe 'test an instance of OrdersList' do
    it 'should create an instance of OrdersList' do
      expect(@instance).to be_instance_of(AmznSpApi::OrdersApiModel::OrdersList)
    end
  end
