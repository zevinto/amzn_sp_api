...
module AmznSpApi::OrdersApiModel
  ...
  class OrderItemApprovals
    ...
    attr_accessor :approval_type, :approval_status, :item_approvals
    ...
    def initialize(attributes = {})
      raise ArgumentError, 'The input argument (attributes) must be a hash in `AmznSpApi::OrdersApiModel::OrderItemApprovals` initialize method' unless attributes.is_a?(Hash)

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) do |(k, v), h|
        raise ArgumentError, "`#{k}` is not a valid attribute in `AmznSpApi::OrdersApiModel::OrderItemApprovals`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect unless self.class.attribute_map.key?(k.to_sym)
      ...
      return unless attributes.key?(:item_approvals)
      return unless (value = attributes[:item_approvals]).is_a?(Array)

      self.item_approvals = value
    end
    ...
    def list_invalid_properties
      ...
      invalid_properties.push('invalid value for "item_approvals", item_approvals cannot be nil.') if @item_approvals.nil?
    ...
    def valid?
      ...
      return false if @item_approvals.nil?
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        item_approvals == other.item_approvals
    end
    ...
    def hash
      [order_item_id, approval_type, approval_status, item_approvals].hash
    end
