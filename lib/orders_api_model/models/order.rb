...
module AmznSpApi::OrdersApiModel
  ...
  class Order
    ...
    attr_accessor :order_total, :payment_execution_detail, :payment_method_details, :easy_ship_shipment_status, :default_ship_from_location_address, :buyer_tax_information, :fulfillment_instruction, :marketplace_tax_info, :shipping_address, :buyer_info, :automated_shipping_settings, :electronic_invoice_status
    ...
    def order_status=(order_status)
      validator = EnumAttributeValidator.new('Object', %w[Pending Unshipped PartiallyShipped Shipped Canceled Unfulfillable InvoiceUnconfirmed PendingAvailability])
      raise ArgumentError, "invalid value for \"order_status\", must be one of #{validator.allowable_values}." unless validator.valid?(order_status)
    ...
    def fulfillment_channel=(fulfillment_channel)
      validator = EnumAttributeValidator.new('Object', %w[MFN AFN])
      raise ArgumentError, "invalid value for \"fulfillment_channel\", must be one of #{validator.allowable_values}." unless validator.valid?(fulfillment_channel)
    ...
    def payment_method=(payment_method)
      validator = EnumAttributeValidator.new('Object', %w[COD CVS Other])
      raise ArgumentError, "invalid value for \"payment_method\", must be one of #{validator.allowable_values}." unless validator.valid?(payment_method)
    ...
    def order_type=(order_type)
      validator = EnumAttributeValidator.new('Object', %w[StandardOrder LongLeadTimeOrder Preorder BackOrder SourcingOnDemandOrder])
      raise ArgumentError, "invalid value for \"order_type\", must be one of #{validator.allowable_values}." unless validator.valid?(order_type)
    ...
    def buyer_invoice_preference=(buyer_invoice_preference)
      validator = EnumAttributeValidator.new('Object', %w[INDIVIDUAL BUSINESS])
      raise ArgumentError, "invalid value for \"buyer_invoice_preference\", must be one of #{validator.allowable_values}." unless validator.valid?(buyer_invoice_preference)
