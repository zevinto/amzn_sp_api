...
module AmznSpApi::OrdersApiModel
  ...
  class Address
    ...
    def address_type=(address_type)
      validator = EnumAttributeValidator.new('Object', %w[Residential Commercial])
      raise ArgumentError, "invalid value for \"address_type\", must be one of #{validator.allowable_values}." unless validator.valid?(address_type)
